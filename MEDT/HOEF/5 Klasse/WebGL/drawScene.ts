...
function drawScene(gl: WebGLRenderingContext, programInfo: ProgramInfo, buffers: Buffers, squareRotation: number) {
...
function setPositionAttribute(gl: WebGLRenderingContext, buffers: Buffers, programInfo: ProgramInfo) {
    ...
    gl.vertexAttribPointer(
        programInfo.attribLocations.vertexPosition, // String mit dem Variablen Namen
        numComponents,
        type,
        normalize,
        stride,
